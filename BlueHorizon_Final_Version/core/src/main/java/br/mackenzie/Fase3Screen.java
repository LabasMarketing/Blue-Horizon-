...
public class Fase3Screen extends FaseBaseScreen{
    ...
    private Texture fogueteTexture;
    ...
    public void show() {
        ...
        fogueteTexture = new Texture("Imagens_Fase3/Foguete.png");
        sateliteTexture = new Texture("Imagens_Fase3/Satelite.png");
        inimigos = new Array<>();
        
        // Power-ups
        //Pato
        patoTexture = new Texture("Imagens_Fase3/Pato.png");
        patoTimerTexture = new Texture("Imagens_Fase3/Imagens_UI/Pato_PU.png");
        playerPatoTexture = new Texture("Imagens_Personagem/Imagem_bonus_commit.png");
        //Shield
        shieldTexture = new Texture("Imagens_Fase3/EnergyShield.png");
        shieldTimerTexture = new Texture("Imagens_Fase3/Imagens_UI/Shield_PU.png");
        powerUps = new Array<>();
        //Extra
        patoShieldPlayerTexture = new Texture("Imagens_Fase3/Imagens_player_shield/Imagem_bonus_shield.png");

        // Vida
        heartTexture = new Texture("Imagens_Fase3/heart-life.png");
        ...
        // Pause
        pauseButtonTexture = new Texture("Imagens_Fase3/Imagens_UI/Pause_button.png");
        playButtonTexture = new Texture("Imagens_Fase3/Imagens_UI/Play_button.png");
        menu_pause = new Texture("Imagens_Fase3/Imagens_UI/Menu_fase.png");
        ...
        for (int i = 0; i < 8; i++) {
            ...
            Texture t2 = new Texture("Imagens_Fase3/Imagens_player_shield/Imagem" + (i + 1) + "Shield.png");
        ...
        // Barra de Progresso
        barraAzulEscuroTexture = new Texture("Imagens_Fase3/Barra_de_progresso/barra_azul_escuro.png"); 
        barraAzulClaroTexture = new Texture("Imagens_Fase3/Barra_de_progresso/barra_azul_claro.png");
        IconePlayerTexture = new Texture("Imagens_Fase3/Barra_de_progresso/player_barra.png");
        chegadaTexture = new Texture("Imagens_Fase3/Barra_de_progresso/chegada.png");
        ...
        fundoChegadaTexture = new Texture("Imagens_Fase3/Fundo_fase3_chegada.png");
        vitoriaImagemTexture = new Texture("Imagens_Fase3/vitoria.png");
    ...
    private void spawnInimigos(float dt){
        ...
        if (inimigoTimer > 1f) {
            ...
            int chanceInimigo = MathUtils.random(0, 4);
            ...
            switch (chanceInimigo) {
                case 0:
                    newInimigo = new Inimigo(naveTexture, worldWidth, spawnY, 0.6f, 0.6f,this);
                    break;
                case 1:
                    newInimigo = new Inimigo(fogueteTexture, worldWidth, spawnY, 0.6f, 0.6f,this);
                    break;
                case 2:
                    newInimigo = new Inimigo(sateliteTexture, worldWidth, spawnY, 0.6f, 0.6f,this);
                    break;
                default:
                    break;
            }
    ...
    private void spawnPowerUps(float dt){
        ...
        if (powerUpTimer > 3f) { 
            ...
            int chancePowerUp = MathUtils.random(0, 8);
            float spawnY; 
            int slotY = MathUtils.random(0, 2);
            ...
            switch (chancePowerUp) {
                case 0:
                    ...
                    break;
                case 1:
                    powerUp = new Shield(shieldTexture, worldWidth, spawnY, 0.9f, 0.6f, shieldSound,this);
                    break;
            }
            if (powerUp != null) {
