...
public class Fase1Screen extends FaseBaseScreen{

    public Fase1Screen(Main game) {
        super(game);
    }
    ...
    private final float MAX_PROGRESS_TIME = 180f; // 300f 0.98 180 0.96
    ...
    public void show() {
        ...
        // Player
        //Carregamento dos frames nadador
        ...
        chegadaTexture = new Texture("Imagens_Fase1/Barra_de_progresso/chegada.png");
        ...
        fundoChegadaTexture = new Texture("Imagens_Fase1/Fundo_fase1_chegada.png");
        vitoriaImagemTexture = new Texture("Imagens_Fase1/vitoria.png");
    ...
    private void updateGameObjects(float dt) {
        ...
        // Se o player está se movendo (nadando com o mouse ou tecla)
        if (player.isMoving()) { 
            // Move o player para a direita em uma velocidade constante (Ex: 1.5 unidades/s)
        ...
        if (esperandoCicloParalaxe) {
            ...
            if (distanceIntoCurrentCycle < 0.1f) { 
                ...
                // Se a rolagem do fundo já está no início de um novo ciclo, trocamos.
                // Se a faseAtual.setBackground() lida com a troca, chamamos ela.
    ...
    private void spawnInimigos(float dt){
        ...
        if (inimigoTimer > 1f) {
            ...
            int chanceInimigo = MathUtils.random(0, 8);
    ...
    private void spawnPowerUps(float dt){
        ...
        if (powerUpTimer > 3f) { 
            ...
            int chancePowerUp = MathUtils.random(0, 4);
            float spawnY; 
            int slotY = MathUtils.random(0, 2);
    ...
    private void drawUI() {
        ...
        float y = uiHeight - Icone_Height - Padding - 60f;
